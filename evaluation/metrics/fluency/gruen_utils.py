...
def get_cola_score(sentences):
    ...
    def evaluate_cola(model, candidates, tokenizer, model_name):
        def load_and_cache_examples(candidates, tokenizer):
            ...
            # hide warning about `glue_convert_examples_to_features` being deprecated
            # and will be removed from the library soon
            transformers.modeling_utils.logger.setLevel(logging.ERROR)
    ...
    model_name = "bert-base-cased"
    # from parent of this file using pathlib
    saved_pretrained_CoLA_model_dir = Path(__file__).parent / "cola_model" / model_name
...
if __name__ == "__main__":
    candidates = [
        ...
        "This is a bad example. It is ungrammatical and redundant. Orellana shown red"
        " card for throwing grass at Sergio Busquets. Orellana shown red card for"
        " throwing grass at Sergio Busquets.",
    ]
